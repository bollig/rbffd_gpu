...
\NOTE{The plane rotation function may not work as expected on some GPUs. If this is the case, library users are advised to use separate result vectors and write the operations explicitly using the other BLAS level 1 functions.}
...
equations. See Section \ref{sec:iterative-solvers} for more details on linear
solvers.}
