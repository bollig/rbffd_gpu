...
// more accuracy.
double NestedSphereCVT::computeBoundaryIntegral(Density& rho, unsigned int npts, vector<double>& intg, double major, double minor)
{
    double pi = acos(-1.);
...
double NestedSphereCVT::computeDomainIntegral(unsigned int npts, Density& rho) {
...
//
void NestedSphereCVT::computeBoundaryPointDistribution(int dim_num, double tot_length, double major, double minor, int npts, int nb_bnd, std::vector<double> intg, double bnd[]) {
