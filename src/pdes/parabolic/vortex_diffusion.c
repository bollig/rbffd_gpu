...
void VortexDiffusion::solve(std::vector<SolutionType>& u_t, std::vector<SolutionType>* f_out, unsigned int n_stencils, unsigned int n_nodes, double t) {
...
void VortexDiffusion::setupTimers() {
