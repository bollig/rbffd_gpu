...
int main(int argc, char** argv) {
    Timings tm;
    Timer t1(tm, "[t1] Total"), t2(tm, "[t2] DistributeDomains"), t3(tm, "[t3] ReceiveDomain"),
          t4(tm, "[t4] CompWeights"), t5(tm, "[t5] CompDerivs"), t6(tm, "[t6] HeatTimestep"),
          t7(tm, "[t7] BroadcastUpdates"), t8(tm, "[t8] ConsolidateResults"), t9(tm, "[t9] GenGrid and Stencils");
