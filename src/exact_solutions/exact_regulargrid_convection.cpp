...
#include "exact_regulargrid_convection.h"


//----------------------------------------------------------------------
ExactRegularGridConvection::ExactRegularGridConvection(int dimension, double freq)
    : ExactSolution(dimension)
{
    this->freq = freq;
}
//----------------------------------------------------------------------
ExactRegularGridConvection::~ExactRegularGridConvection()
{}

//----------------------------------------------------------------------
double ExactRegularGridConvection::operator()(double x, double y, double z, double t)
{
...
double ExactRegularGridConvection::laplacian1D(double x, double y, double z, double t)
{
    double decay = this->diffuseCoefficient(x,y,z,t);
    return -exp(-decay * t) * freq * freq * cos(x); 
}

double ExactRegularGridConvection::laplacian2D(double x, double y, double z, double t)
{
    double decay = this->diffuseCoefficient(x,y,z,t);
...
double ExactRegularGridConvection::laplacian3D(double x, double y, double z, double t)
{
    double decay = this->diffuseCoefficient(x,y,z,t);
...
//----------------------------------------------------------------------
double ExactRegularGridConvection::laplacian(double x, double y, double z, double t)
{
    if (dim_num == 1) {
        ...
        printf("[ExactRegularGridConvection] ERROR: only dimensions 1, 2, and 3 are valid.\n"); 
        exit(EXIT_FAILURE);
    }
}
//----------------------------------------------------------------------
double ExactRegularGridConvection::xderiv(double x, double y, double z, double t)
{
    double decay = this->diffuseCoefficient(x,y,z,t);
    double r = sqrt(x*x + y*y + z*z); 
    if (r < 1e-10) {
...
//----------------------------------------------------------------------
double ExactRegularGridConvection::yderiv(double x, double y, double z, double t)
{
    double decay = this->diffuseCoefficient(x,y,z,t);
    double r = sqrt(x*x + y*y + z*z); 
    if (r < 1e-10) {
...
//----------------------------------------------------------------------
double ExactRegularGridConvection::zderiv(double x, double y, double z, double t)
{
    double decay = this->diffuseCoefficient(x,y,z,t);
    double r = sqrt(x*x + y*y + z*z); 
    if (r < 1e-10) {
...
//----------------------------------------------------------------------
double ExactRegularGridConvection::tderiv(double x, double y, double z, double t)
{
    double decay = this->diffuseCoefficient(x,y,z,t);
