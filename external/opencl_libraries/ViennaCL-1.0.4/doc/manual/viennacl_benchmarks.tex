...
\TIP{Due to only partial support of double precision by GPUs from ATI, the benchmarks do not include double precision arithmetics there, cf.~Tab.~\ref{tab:double-precision-GPUs}.}
