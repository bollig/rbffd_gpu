  ...
  namespace linalg
  {
    ...
    namespace detail
    {
                  ...
                  )
      {
        ...
        std::cout << "Running add_sub_impl" << std::endl;
    ...
    */
                    ...
                    VectorType2 & result)
    {
      ...
      viennacl::ocl::enqueue(k(viennacl::traits::handle(mat),
                               ...
                               cl_uint(viennacl::traits::start(vec)),         cl_uint(viennacl::traits::size(vec)), 
                               viennacl::traits::handle(result),
                               cl_uint(viennacl::traits::start(result)),         cl_uint(viennacl::traits::size(result))
                             ) );
    }
