...
#include "rbffd/rbffd_vcl_overlap_project.h"
#include "rbffd/spmv_test_vcl_overlap_faster.h"
...
int main(int argc, char** argv) {
    ...
    tm["derSetup"]->start();
    RBFFD_VCL_OVERLAP_PROJECT* der = new RBFFD_VCL_OVERLAP_PROJECT(weight_choices, subdomain, grid_dim, mpi_rank);
