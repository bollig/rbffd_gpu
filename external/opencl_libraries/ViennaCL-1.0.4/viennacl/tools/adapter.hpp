/* =======================================================================
   ...
   file changelog: - Jul 5, 2010   Extracted from tools.hpp
======================================================================= */
    ...
    */
    ...
    class const_sparse_matrix_adapted_iterator
    {
      ...
      public:
        ...
        {
          return const_sparse_matrix_adapted_iterator<SCALARTYPE, !is_iterator1, 1>(_mat, _i, static_cast<unsigned int>(_mat.size()));
        }
