...
#include "alt_ellipsoid_cvt.h"

using namespace std;

#if 0
//****************************************************************************80
    AltEllipsoidCVT::AltEllipsoidCVT(double major_, double minor_, double midax_, int DEBUG_)
: CVT(DEBUG_) 
{ 
    nb_bnd = 0;
}
...
void AltEllipsoidCVT::displaceBoundaryNodes(int dim_num, int nb_bnd_nodes, double r_computed[], double r_updated[]) 
{
#if 0
...
//----------------------------------------------------------------------
void AltEllipsoidCVT::ellipsoid_init ( int dim_num, int& n, int *seed, double r[] )
{
...
//----------------------------------------------------------------------
void AltEllipsoidCVT::ellipsoid ( int dim_num, int& n, int *seed, double r[] )
...
//----------------------------------------------------------------------
void AltEllipsoidCVT::rejection3d(int nb_samples, Density& density, vector<Vec3>& samples)
...
//----------------------------------------------------------------------
Vec3 AltEllipsoidCVT::singleRejection3d(Density& density)
{
...
//****************************************************************************
#if 0
void AltEllipsoidCVT::cvt_iterate ( int dim_num, int n, int batch, int sample, bool initialize,
...
//  Purpose:
//
//    AltEllipsoidCVT_ITERATE takes one step of the AltEllipsoidCVT iteration.
//
//  Discussion:
//
...
//
//    Each time this AltEllipsoidCVT iteration is carried out, an attempt is made
...
void AltEllipsoidCVT::user_sample(int dim_num, int n, int *seed, double r[]) {
...
void AltEllipsoidCVT::user_init(int dim_num, int n, int *seed, double r[]) {
...
void AltEllipsoidCVT::fillBoundaryPoints(int dim_num, int nb_nodes, int *seed, double bndry_nodes[])
{
...
void AltEllipsoidCVT::computeBoundaryPointDistribution(int dim_num, double tot_length, int npts, int nb_bnd, std::vector<double> intg, double bnd[]) {
