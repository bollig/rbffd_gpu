...
"      dot_prod += A[(row+A_col_start) * A_internal_rows + col] * v[v_start + col];\n"
"    result[row + result_start] = dot_prod;\n"
"  }\n"
"}\n"
...
"      dot_prod += A[(row+A_row_start) + col * A_internal_rows] * v[v_start + col];\n"
"    result[row + result_start] = dot_prod;\n"
"  }\n"
"}\n"
