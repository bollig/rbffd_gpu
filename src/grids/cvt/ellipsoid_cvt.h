...
class EllipsoidCVT : public CVT {
    ...
    public:
        ...
        EllipsoidCVT (unsigned int nb_generators, unsigned int dimension, Density* density_func, double major_axis, double minor_axis, double midax_axis, unsigned int num_samples=2000, unsigned int max_num_iters=10, unsigned int write_freq=100, unsigned int sample_batch_size=1000)
