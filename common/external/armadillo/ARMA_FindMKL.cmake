...
set(LD_LIBS ".:$ENV{LD_LIBRARY_PATH}")
STRING(REPLACE ":" ";" LD_LIB_PATHS ${LD_LIBS})
#MESSAGE("EVAN: ${LD_LIB_PATHS}")
...
IF (MKL_FOUND)
    #ADD_DEFINITIONS("-shared-intel -openmp")
    SET(CMAKE_EXE_LINKER_FLAGS "-shared-intel -openmp")
