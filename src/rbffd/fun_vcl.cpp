...
//----------------------------------------------------------------------
//
FUN_VCL::FUN_VCL(DerTypes typesToCompute, Grid* grid, int dim_num, int rank)
: RBFFD_VCL(typesToCompute, grid, dim_num, rank)
{
...
//----------------------------------------------------------------------
#if 0
void FUN_VCL::setKernelType(KernelType kernel_type_)
{
...
#endif
//----------------------------------------------------------------------
void FUN_VCL::allocateGPUMem()
{
#if 0
	//RBFFD_VCL::allocateGPUMem();
...
//----------------------------------------------------------------------
#if 0
void FUN_VCL::computeDerivs(SuperBuffer<double>& u, SuperBuffer<double>& deriv_x, 
