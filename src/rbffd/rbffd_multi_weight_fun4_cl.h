#ifndef __RBFFD_MULTI_WEIGHT_FUN4_CL_H__
#define __RBFFD_MULTI_WEIGHT_FUN4_CL_H__
...
class RBFFD_MULTI_WEIGHT_FUN4_CL : public RBFFD_CL
{
    public: 
        ...
        RBFFD_MULTI_WEIGHT_FUN4_CL(DerTypes typesToCompute, Grid* grid, int dim_num, int rank=0);

        virtual ~RBFFD_MULTI_WEIGHT_FUN4_CL() { 
            ...
            std::cout << "RBFFD_MULTI_WEIGHT_FUN4_CL Destroyed\n";
        } 
		...
		{
            std::cout << "[RBFFD_MULTI_WEIGHT_FUN4_CL] Warning! Using GPU to apply weights, but NOT advance timestep\n";
