...
\n
        ...
        FLOAT lapl_u = rewrittenLaplacian(st, lapl_st_weights, x_st_weights, y_st_weights, z_st_weights, deriv_solution_in, diffusivity, nb_stencils, nb_nodes, stencil_size, i);  \n
\n
