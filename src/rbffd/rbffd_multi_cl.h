#ifndef __RBFFD_MULTI_CL_H__
#define __RBFFD_MULTI_CL_H__
...
class RBFFD_MULTI_CL : public RBFFD_CL
{
    public: 
        ...
        RBFFD_MULTI_CL(DerTypes typesToCompute, Grid* grid, int dim_num, int rank=0);

        virtual ~RBFFD_MULTI_CL() { 
            ...
            std::cout << "RBFFD_MULTI_CL Destroyed\n";
        }; 
	...
	void copyResultsToHost(double* deriv_x, double* deriv_y, double* deriv_z, double* deriv_l);
